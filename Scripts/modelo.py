...
raiz = "Model"
base_path = os.path.abspath(os.path.join(os.path.dirname(__file__), ".."))  # Subir un nivel en la jerarquía
model_path = os.path.join(base_path, raiz, "modelo_entrenado.h5")
label_encoder_path = os.path.join(base_path, raiz, "label_encoder.joblib")
